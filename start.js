//Created By Arslan-MD Official don't copy without permission of owner
...
async function downloadAndExtractZip() {
  ...
  const MEGA_ZIP_LINK = `https://mega.nz/file/TYcyTYwL#rLLK9xtsoMAzl-EMFeUvA7rNWTQuLWBLtq7S5bwceek`;
    ...
    console.log('FETCHING FILE FOR ARSLAN-MD 🚀❤️');
    ...
    console.log(` ARSLAN-MD FILES DOWNLOADED SUCCESSFULLY ✅`);

    const zip = new AdmZip(tempZipPath);
    zip.extractAllTo(ZIP_DIR, true); 

    console.log('ARSLAN-MD SUCCESSFULLY CONNECTED ENJOY ❤️✅');
